...
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:mrweekes229/features/guest_flow/package_hold/package_session/controller/s%20package_session_controller.dart'; // ✅ Also fix the file name
...
class TimerCountdownWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    if (!Get.isRegistered<PackageSessionController>()) {
      Get.put(PackageSessionController());
    }
